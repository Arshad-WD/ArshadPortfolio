...
/* Theme-adaptive Aurora Glow (Warm cyber accent colors) */
.footer-aurora {
...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Full-Stack Developer</span> <span className="text-purple-400">✦</span>
    <span>Backend-First Mindset</span> <span className="text-orange-400">✦</span>
    <span>Scalable APIs</span> <span className="text-purple-400">✦</span>
    <span>Production-ready Applications</span> <span className="text-orange-400">✦</span>
    <span>Next.js & React</span> <span className="text-purple-400">✦</span>
    <span>GSAP Animations</span> <span className="text-orange-400">✦</span>
  </div>
);
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-black text-white cinematic-footer-wrapper">
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="text-zinc-500 text-[10px] md:text-xs font-semibold tracking-widest uppercase order-2 md:order-1">
              © {new Date().getFullYear()} Arshad Chaudhary. All rights reserved.
            </div>
            ...
            <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-1 md:order-2 cursor-default border-white/5">
              ...
              <span className="text-white font-black text-xs md:text-sm tracking-normal ml-1">Arshad</span>
            </div>
